...
export const IndexPageTemplate = () => {
    ...
    return (
        <div>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Chris Online | Technisch sterke websites</title>
                <meta
                    name="description"
                    content="Een goede website is nooit af. Daarom elke 2 maanden een uitgebreide analyse, waarbij alle aanpassingen gratis zijn! Start nu je project!"
                />
            </Helmet>
            <main className="py-10 mx-auto max-w-screen-xl sm:py-12 md:py-16 lg:py-20 xl:py-28">
                <div className="sm:text-center lg:text-left">
                    ...
                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        ...
                        website die zorgt voor betere posities in Google, hogere
                        conversieratio en een uitstekende user experience.
                        <br />
                ...
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="lg:text-center">
                        ...
                        <p className="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
                            Een technisch sterke website waarmee je meteen een
                            voorsprong hebt op je concurrentie.
                        </p>
                    </div>
                                ...
                                <div className="flex">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-2 text-base leading-6 text-gray-500">
                                            ...
                                            templates. Zo krijgt iedere website
                                            gegarandeerd de beste performance en
                                            ervaring.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <li className="mt-10 md:mt-0 mb-8">
                                <div className="flex">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-2 text-base leading-6 text-gray-500">
                                            Mobile first ontwerp, volledig
                                            schaalbaar op elk apparaat. Een must
                                            voor een moderne website.
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li className="mt-10 md:mt-0 mb-4">
                                <div className="flex">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-2 text-base leading-6 text-gray-500">
                                            Door alleen code te gebruiken die
                                            nodig is, heb je met je snelle
                                            website een grote voorsprong op je
                                            concurrenten.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <li className="mt-10 md:mt-0">
                                <div className="flex">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-2 text-base leading-6 text-gray-500">
                                            Eenvoudig je website aanpassen en
                                            up-to-date houden door je content
                                            aan te passen via jouw CMS systeem.
                                        </p>
                                    </div>
                                </div>
                            </li>
